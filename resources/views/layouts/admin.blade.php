...
<head>
    ...
    <script>
        var editor_config = {
path_absolute : "http://localhost:8888/laravel-unitop.vn/",
selector: "textarea",
plugins: [
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                ...
                <li class="nav-link {{$a =='dashboard'?'active':''}}">
                    ...
                    @endphp
                    <li class="nav-link {{$a =='post'?'active':''}}">
                    ...
                    <li class="nav-link {{$a =='product'?'active':''}}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{url('admin/product/list/color')}}">Danh sách màu</a></li>
                    ...
                    <li class="nav-link ">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{url('admin/role/update')}}">Danh sách</a></li>
                        </ul>
                    </li>
