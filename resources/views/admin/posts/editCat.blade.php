    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{route('cat/update' , $cat_post_1->id)}}">
                        <div class="form-group">
                            @error('name')
                            <div class="form-text text-danger">{{$message}}</div>
                                @enderror
                            <label for="name">Tên danh mục</label>
                        <input class="form-control" type="text" value="{{$cat_post_1->name}}" name="name" id="name">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-text text-danger">{{$message}}</div>
                                @enderror
                            <input class="form-control" value="{{$cat_post_1->slug}}" type="text" name="slug" id="name">
                        </div>

                        <div class="form-group">
                            <label for="">Trạng thái</label>
                            @if($cat_post_1->status_id == 1)
